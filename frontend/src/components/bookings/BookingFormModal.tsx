      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-xs font-semibold text-slate-600 mb-1">OTA Source</label>
              <select value={form.ota_source} onChange={set('ota_source')} className="w-full border border-slate-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                {(Object.keys(OTA_LABEL) as OTASource[]).map((s) => (
                  <option key={s} value={s}>{OTA_LABEL[s]}</option>
                ))}
              </select>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-xs font-semibold text-slate-600 mb-1">Guest Phone</label>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-xs font-semibold text-slate-600 mb-1">Total Price (VND) *</label>
            ...
            <div>
              <label className="block text-xs font-semibold text-slate-600 mb-1">Booking Ref</label>
